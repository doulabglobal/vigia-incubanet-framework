...
- **MicroCanvas Framework 2.1 (MCF 2.1)** — evidence-driven venture development  
- **Innovation Maturity Model Program (IMM‑P®)** — capability and governance maturity  
- **Vigía Futura** — strategic foresight and sector prioritization  
...
- **Evidence-based** (MCF 2.1 at its core)  
- **Foresight-driven** (Vigía Futura)  
- **Maturity-aware** (IMM-P®)  
