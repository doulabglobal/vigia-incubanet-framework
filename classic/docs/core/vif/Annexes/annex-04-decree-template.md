---
id: annex-04-decree-template
title: "Annex 04  -  National Decree Template"
sidebar_label: "National Decree Template"
---
...
```mermaid
flowchart TD
    A(Decree Purpose) --> B(Governance Bodies)
    B --> C(Funding & Investment Rules)
    C --> D(Accreditation System)
    D --> E(Reporting & Transparency)
    E --> F(Legal Authority)
    F --> G(Amendment & Repeal)
```
